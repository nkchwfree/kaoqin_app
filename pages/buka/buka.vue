<template>
	<view class="basement">
		<uni-forms ref="form" :modelValue="formData" :rules="rules" label-position="top">
			...
			<uni-forms-item label="补卡类型 :" name="type" label-position="left">
				<input type="text" disabled v-model="formData.type" />
			</uni-forms-item>
			<!-- <uni-icons type="cart"></uni-icons> -->
			</uni-forms-item>
			<uni-forms-item label="缺卡时间:" name="name">
				<uni-datetime-picker :border='false' return-type="timestamp" v-model="formData.datetime" type="datetime"
					start="2023-03-01" end="2023-06-01" :hide-second="true" @change="timestampChange"
					placeholder="请选择缺卡的实际打卡时间" />
			</uni-forms-item>

			<uni-forms-item label="缺卡事由:" name="reason">
				<input class="uni-input" v-model="formData.reason" type="text" placeholder="请填写缺卡事由" />
			</uni-forms-item>
